...
<template>
  <div class="projects-container animate-fade-in">
    ...
    <div v-else class="projects-grid">
      <div v-for="project in projects" :key="project.id" class="project-card card-glass hover:card-hover">
        ...
        <div class="project-actions">
          <router-link :to="`/projects/${project.id}`" class="btn btn-sm btn-glass">
          ...
          <router-link :to="`/projects/${project.id}/edit`" class="btn btn-sm btn-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon-sm" viewBox="0 0 20 20" fill="currentColor">
