  ...
  <div class="home-container animate-fade-in">
    <header class="home-header glass-card bg-aurora-gradient-diagonal">
      ...
      <div class="action-buttons">
        <router-link to="/projects" class="btn btn-primary"> View Your Projects </router-link>
        <router-link to="/projects/new" class="btn btn-glass"> Create New Project </router-link>
      </div>
    </header>

    <section
      class="stats-section"
      v-if="recentProjects.length > 0 || recentContentPieces.length > 0"
    >
        ...
        <div class="stats-card card-glass hover:card-hover">
          ...
          <ul v-else class="stats-list">
            <li v-for="content in recentContentPieces" :key="content.id" class="stats-item">
              ...
              <span class="content-type badge badge-primary">{{
    ...
    <section class="features-section">
      ...
      <div class="features-grid">
        <div class="feature-card card-glass hover:card-hover">
          <div class="feature-icon">
            ...
            >
              ...
              <path
                d="M17.5 20h-11a2.5 2.5 0 0 1 0-5h11a2.5 2.5 0 0 0 0-5h-11a2.5 2.5 0 0 1 0-5h11"
              ></path>
            </svg>
          </div>
        ...
        <div class="feature-card card-glass hover:card-hover">
          ...
          <p class="feature-description">Generate content in seconds with powerful AI models.</p>
        </div>
      </div>
    </section>
  </div>
